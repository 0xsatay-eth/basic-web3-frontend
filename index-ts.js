...
function fund() {
    return __awaiter(this, void 0, void 0, function () {
        var ethAmount, connectedAccount, accounts, chain, request, hash;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    console.log((0, viem_1.formatEther)(balanceInWei));
                    return [2 /*return*/];
            }
        });
    });
...
function withdraw() {
    return __awaiter(this, void 0, void 0, function () {
        var connectedAccount, accounts, chain, request, hash;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (!(typeof window.ethereum !== "undefined")) return [3 /*break*/, 2];
